...
class TitleText extends StatelessWidget {
  ...
  const TitleText({super.key, required this.label, this.fontFamily = jakartaSemibold, this.customColor = false, this.textColor, this.heightSpaceing = 1.3, this.textAlign = TextAlign.start, this.maxLines = 2});
