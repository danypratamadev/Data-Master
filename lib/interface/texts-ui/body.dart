...
class BodyText extends StatelessWidget {
  ...
  const BodyText({super.key, required this.label, this.fontFamily = interRegular, this.customColor = false, this.textColor, this.heightSpaceing = 1.3, this.textAlign = TextAlign.start, this.maxLines = 2});
